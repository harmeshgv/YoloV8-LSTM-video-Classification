...
from src.data_extraction.feature_extractor import VideoFeatureExtractor
...
class VideoDataExtractor:
    ...
    def extract_video_data(self, video_path, output_csv_path, output_folder=None, show_video=False, save_video=False):
        ...
        try:
            ...
            # Process frames
            for frame_idx in tqdm(range(0, total_frames, frame_skip), desc="Processing video"):
                ...
                if frame_data is not None:
                    ...
                    for interaction in frame_data["interactions"]:
                        ...
                        if interaction_id not in seen_interactions:
                            ...
                            row = self._create_interaction_row(video_name, frame_data, interaction)
                            csv_data.append(row)
    ...
    def _create_interaction_row(self, video_name, frame_data, interaction):
